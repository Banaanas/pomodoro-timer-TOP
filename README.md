...
<br/>
<p align="center">
    <a href="https://pomodoro-timer.cyrilo.app/">
...
ES6 - setTime()/clearInterval Methods - DOM manipulation
...
```sh
git clone https://github.com/Banaanas/pomodoro-timer-TOP.git
```
...
Cyrilo - [Personal Website](https://cyrilo.dev) - [Dr. Ken Lunde](mailto:lunde@adobe.com?subject=[GitHub]%20Source%20Han%20Sans)
